...
const tourDates = [
  ...
  { id: 3, month: "February", city: "Morristown, NJ", dates: "Feb 19–21", status: "confirmed", label: "NEW" },
  { id: 4, month: "February", city: "Tampa, FL", dates: "Feb 19–21", status: "confirmed", label: null },
  { id: 5, month: "February", city: "Worcester, MA", dates: "Feb 26–28", status: "confirmed", label: null },

  // March 2027
  { id: 6, month: "March", city: "Hartford / Springfield, MA", dates: "Mar 12–14", status: "confirmed", label: null },
  { id: 7, month: "March", city: "Long Island, NY", dates: "Mar 12–14", status: "confirmed", label: null },
  { id: 8, month: "March", city: "Nashua, NH", dates: "Mar 19–21", status: "confirmed", label: null },

  // April 2027
  { id: 9, month: "April", city: "Manchester, NH", dates: "Apr 2–4", status: "confirmed", label: null },
  { id: 10, month: "April", city: "Woodbridge, VA", dates: "Apr 2–4", status: "confirmed", label: null },
  { id: 11, month: "April", city: "Woonsocket, RI", dates: "Apr 9–11", status: "confirmed", label: null },
  { id: 12, month: "April", city: "Worcester, MA", dates: "Apr 9–11", status: "confirmed", label: null },
  { id: 13, month: "April", city: "Chicago, IL", dates: "Apr 16–18", status: "confirmed", label: null },
  { id: 14, month: "April", city: "Columbus, OH", dates: "Apr 16–18", status: "confirmed", label: null },
  { id: 15, month: "April", city: "Vernon, CT", dates: "Apr 23–25", status: "confirmed", label: null },
  { id: 16, month: "April", city: "Worcester, MA", dates: "Apr 30 – May 2", status: "confirmed", label: null },

  // May 2027
  { id: 17, month: "May", city: "Albany, NY", dates: "May 7–9", status: "confirmed", label: null },

  // Nationals 2027 — The Iconic Celebration
  { id: 18, month: "Nationals", city: "Virginia Beach, VA", dates: "June 28 – July 2", status: "nationals", label: null },
  { id: 19, month: "Nationals", city: "Mystic, CT", dates: "July 12–16", status: "nationals", label: null }
];
...
function createMonthFilters() {
  ...
  const months = ["All", "February", "March", "April", "May", "Nationals"];
